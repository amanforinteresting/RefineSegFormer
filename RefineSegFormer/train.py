...
if __name__ == "__main__":
    ...
    if model_path != '':
        ...
        if local_rank == 0:
            ...
            print("\n\033[1; 33; 44m warm tips, it is normal that the head part is not loaded, and it is wrong that the backbone part is not loaded\ 033[0m")
    ...
    if local_rank == 0:
        ...
        if total_step <= wanted_step:
            ...
            print("\n\033[1; 33; 44m[warning] when using the%s optimizer, it is recommended to set the total training step to more than%d\ 033[0m "% (optimizer_type, wanted_step))
            print("\033[1; 33; 44m[warning] the total amount of training data in this run is%d, unfreeze_batch_size is%d, a total of%d epochs are trained, and the total training step is calculated as% d。\033[0m"%(num_train, Unfreeze_batch_size, UnFreeze_Epoch, total_step))
            print("\033[1; 33; 44m[warning] since the total training step size is%d, which is less than the recommended total step size of%d, it is recommended to set the total generation to% d。\033[0m"%(total_step, wanted_step, wanted_epoch))
